...
STEERING_TOGGLES = (
  ...
  ToggleDefinition(
    ...
    param="TiSteerMax",
    button_labels=["Reset"],
    description=("<b>The most steering effort openpilot can ask the interceptor for.</b> Lower this to cap how strong assist can get. The interceptor ignores anything above 600."),
    max_value=600,
    min_value=100,
